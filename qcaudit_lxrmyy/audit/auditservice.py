...
#             data.instruction = item.get('name', '')
#             data.totalScore = item.get('score')
#             problemExt = item.get('ext', {})
#             if problemExt:
#                 data.documentName = emrDict.get(problemExt.get('docId', ''), "")
#                 data.docId = problemExt.get('docId', '')
#                 data.createTime = problemExt.get('createTime', '')
#                 data.operatorName = problemExt.get('operatorName', '')
#                 data.problemCount = problemExt.get('problemCount', 0)
#                 data.singleScore = problemExt.get('singleScore', 0)
#         return response
