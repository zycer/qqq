...
from qcaudit_cd6h.audit.caseapplication import CaseApplication
...
from qcaudit_cd6h.audit.auditapplication import AuditApplication
...
class Context(_Context):
    ...
    def customizeApplication(self):
        ...
        self._auditApps[AUDIT_TYPE_DEPARTMENT] = DepartmentAuditApplication(self.app)
